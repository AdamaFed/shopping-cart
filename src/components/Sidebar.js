...
const Sidebar = () => {
  ...
  return ( <div className={` ${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
    ...
    <div   
    onClick={handleClose} className='cursor-pointer w-8 h-8 flex justify-center items-center'> 
    ...
    <div className='flex flex-col gap-y-1  py-4 mt-0 '>
      <div className='flex w-full justify-between items-center'>
        <div className='uppercase font-smibold'> 
